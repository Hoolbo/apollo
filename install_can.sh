...
echo "安装systemd服务..."
# 更新服务文件中的脚本路径为绝对路径
sed "s|/home/hoolbo/code/apollo/start_can_interface.sh|${SCRIPTS_DIR}/start_can_interface.sh|g" \
    "${SCRIPTS_DIR}/${SERVICE_FILE}" > /tmp/mycar-can@.service
