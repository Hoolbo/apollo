...
ReedsSheppPath::ReedsSheppPath(const ReedsSheppPathSegmentType *type, double t,
...
namespace
{
    ...
    void CCSC(double x, double y, double phi, ReedsSheppPath &path)
    {
        ...
        {
            path =
                ReedsSheppPath(reedsSheppPathType[4], -t, .5 * pi, -u, -v);
            Lmin = L;
        }
        ...
        {
            path =
                ReedsSheppPath(reedsSheppPathType[5], -t, .5 * pi, -u, -v);
            Lmin = L;
        }
        ...
        {
            path =
                ReedsSheppPath(reedsSheppPathType[8], -t, .5 * pi, -u, -v);
            Lmin = L;
        }
        ...
        {
            path =
                ReedsSheppPath(reedsSheppPathType[9], -t, .5 * pi, -u, -v);
            Lmin = L;
        }
        ...
        {
            path =
                ReedsSheppPath(reedsSheppPathType[6], -v, -u, .5 * pi, -t);
            Lmin = L;
        }
        ...
        {
            path =
                ReedsSheppPath(reedsSheppPathType[7], -v, -u, .5 * pi, -t);
            Lmin = L;
        }
        ...
        {
            path =
                ReedsSheppPath(reedsSheppPathType[10], v, u, -.5 * pi, t);
            Lmin = L;
        }
        ...
        {
            path =
                ReedsSheppPath(reedsSheppPathType[11], v, u, -.5 * pi, t);
            Lmin = L;
        }
    ...
    ReedsSheppPath getPath(double x, double y, double phi)
    {
        ReedsSheppPath path;
        CSC(x, y, phi, path);
        CCC(x, y, phi, path);
...
ReedsSheppPath getPath(double x0, double y0, double th0, double x1, double y1, double th1, double rho) {
    double dx = x1 - x0, dy = y1 - y0, c = cos(th0), s = sin(th0);
    double x = c * dx + s * dy, y = -s * dx + c * dy, phi = th1 - th0;
    return getPath(x / rho, y / rho, phi);
}
