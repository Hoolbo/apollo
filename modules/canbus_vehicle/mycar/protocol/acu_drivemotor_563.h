...
class AcuDrivemotor563
 ...
 public:
  ...
  void set_drive_motor_shift(MycarAcuDrivemotor563::ShiftType shift) {
 ...
 private:
  ...
  void set_acu_drivemotor_select_shift(uint8_t* data,
                                       MycarAcuDrivemotor563::ShiftType shift);
  ...
  MycarAcuDrivemotor563::ShiftType drive_motor_shift_ =
      MycarAcuDrivemotor563::SHIFT_P;
