...
class MycarVehicleFactory : public AbstractVehicleFactory {
 public:
  virtual ~MycarVehicleFactory() = default;
 ...
 private:
  ...
  CanSender<::apollo::canbus::Mycar> can_sender_;
  apollo::drivers::canbus::CanReceiver<::apollo::canbus::Mycar> can_receiver_;
  std::unique_ptr<MessageManager<::apollo::canbus::Mycar>> message_manager_;
  std::unique_ptr<VehicleController<::apollo::canbus::Mycar>>
      vehicle_controller_;

  std::shared_ptr<::apollo::cyber::Writer<::apollo::canbus::Mycar>>
      chassis_detail_writer_;
};

CYBER_REGISTER_VEHICLEFACTORY(MycarVehicleFactory)
