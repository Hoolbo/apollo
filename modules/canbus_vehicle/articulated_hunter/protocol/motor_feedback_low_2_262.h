...
class Motorfeedbacklow2262 : public ::apollo::drivers::canbus::ProtocolData<
                    ::apollo::canbus::ArticulatedHunter> {
 public:
  static const int32_t ID;
  Motorfeedbacklow2262();
 ...
 private:
    ...
    double driver_voltage_2(const std::uint8_t* bytes, const int32_t length) const;
    ...
    int driver_temp_2(const std::uint8_t* bytes, const int32_t length) const;
    ...
    int motor_temp_2(const std::uint8_t* bytes, const int32_t length) const;
    ...
    int driver_status_2(const std::uint8_t* bytes, const int32_t length) const;
};
