...
class Motorfeedbackhigh2252 : public ::apollo::drivers::canbus::ProtocolData<
                    ::apollo::canbus::ArticulatedHunter> {
 public:
  static const int32_t ID;
  Motorfeedbackhigh2252();
 ...
 private:
    ...
    int motor2_speed(const std::uint8_t* bytes, const int32_t length) const;
    ...
    double motor2_current(const std::uint8_t* bytes, const int32_t length) const;
};
