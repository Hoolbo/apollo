...
class ArticulatedHunterVehicleFactory : public AbstractVehicleFactory {
 public:
  virtual ~ArticulatedHunterVehicleFactory() = default;
 ...
 private:
  ...
  CanSender<::apollo::canbus::ArticulatedHunter> can_sender_;
  apollo::drivers::canbus::CanReceiver<::apollo::canbus::ArticulatedHunter> can_receiver_;
  std::unique_ptr<MessageManager<::apollo::canbus::ArticulatedHunter>> message_manager_;
  std::unique_ptr<VehicleController<::apollo::canbus::ArticulatedHunter>>
      vehicle_controller_;

  std::shared_ptr<::apollo::cyber::Writer<::apollo::canbus::ArticulatedHunter>>
      chassis_detail_writer_;
};

CYBER_REGISTER_VEHICLEFACTORY(ArticulatedHunterVehicleFactory)
